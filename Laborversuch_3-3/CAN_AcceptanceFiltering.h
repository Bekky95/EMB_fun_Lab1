...
const uint16_t  CAN1_Array_SFF_EXP_IDs[CAN1_Number_SFF_EXP_ID] = {0x101, 0x105}; //{0x701, 0x0705};
/******************************************************************************/
...
const uint16_t  CAN2_Array_SFF_EXP_IDs[CAN2_Number_SFF_EXP_ID] = {0x111, 0x112}; //{0x711, 0x712};
/******************************************************************************/
