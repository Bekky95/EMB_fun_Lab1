...
const uint16_t  CAN1_Array_SFF_EXP_IDs[CAN1_Number_SFF_EXP_ID] = {0x10A, 0x010E}; //{0x701, 0x0705}; {0x100, 0x456};
/******************************************************************************/
...
const uint16_t  CAN2_Array_SFF_EXP_IDs[CAN2_Number_SFF_EXP_ID] = {0x100, 0x456}; //{0x711, 0x712};
/******************************************************************************/
